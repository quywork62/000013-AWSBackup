...
1. Mở email mà bạn đã nhận trước đó để lấy ARN của SNS TOPIC bạn đã tạo
![AWS Backup](/images/4-notification/1.png?featherlight=false&width=90pc)
    
2. Chỉnh sửa lệnh AWS CLI sau và thay thế bằng ARN của SNS TOPIC bạn đã tạo vàà Region. ARN này có thể tìm thấy trong phần đầu ra của CloudFormation Stack.
